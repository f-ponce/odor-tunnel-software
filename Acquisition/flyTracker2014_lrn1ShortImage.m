function flyTracks = flyTracker2014_lrn1ShortImage(occtt,iDoD,ttummy,hept)
    ...
    if stimTimes(ceil(toc))                  % If this is an odor period...
        ...
        if etime(clock, odorTime) >= chargeTime
            ...
            if occtt == true;
                ...
                %if bt == 2 || bt == 3 || bt == 4|| bt == 5 || bt == 9 || bt == 11 || bt == 13 || bt == 15
                if bt == 3 || bt == 5 || bt == 9 || bt == 11 || bt == 13 || bt == 15
                %if bt == 1 
                    blockn = true;
                else
                    blockn = false;
...
%                            end
    ...
    props = regionprops((delta >= 40), propFields); % Get fly properties
