function [stimTimes, stim, duration] = constructStimulus_zach(chargeTime)
...
odors = {'OCT' 'Air'};
conc = [0.166 0.166]; % proportion saturated vapor

odorDur = 5;    % in sec
isi = 30;       % in sec
nBlocks = 100;	% number of odor blocks

preTime = 20;	% wait time before first odor block
postTime = 20;	% wait time after last odor block
