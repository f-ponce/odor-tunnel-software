function flyTracks = flyTracker2014_m
...
% Begin main script
[stimTimes, stim, duration] = constructStimulus_m(AlabeL,BlabeL,false); % Stimlus
                                                           % timecourse
                                                           % for experiment
...
arenaData = detectBackground_m;                   % run bg detection script
