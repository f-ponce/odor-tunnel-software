...
conc = 0.14;                % Odorant concentration
...
pre_time = 30;              % wait time before first odor block (sec)
post_time = 5;              % wait time after last odor block
...
num_reps = 1;               % number of times the shock protocol is repeated
...
for i = 1:num_reps
    ...
    if i < num_reps        % Only pause for the iti if it's not the last rep
    ...
    display(['Finished repetition ' num2str(i)])
