function flyTracks = flyTracker2014_mattc
...
% Begin main script
[stimTimes, stim, duration] = constructStimulus_mattc(chargeTime);
%[stimTimes, stim, duration] = constructStimulus_ms('MCH','OCT');
...
%         if abs(flyTracks.centroid(i,:) - flyTracks.lastCentroid{500}) > 150
%             pause
%         end
