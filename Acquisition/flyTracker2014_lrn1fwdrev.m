function flyTracks = flyTracker2014_lrn1(occtt,iDoD,ttummy)
...
if ttummy
    ...
    [stimTimes, stim, duration] = constructStimulus_lrn1fwdrev(AlabeL,BlabeL,iDoD);
    ...
    if stimTimes(ceil(toc))                  % If this is an odor period...
        ...
        if etime(clock, odorTime) >= chargeTime
            ...
            if occtt == true;
                ...
                %if bt == 3||bt == 5||bt == 7||bt == 9||bt == 14||bt == 16||bt == 21||bt == 23||bt == 25
                
                if bt == 3||bt == 6||bt == 9||bt == 12||bt == 15||bt == 18||bt == 21||bt == 24||bt == 27||bt == 30
                %if bt == 1 
                    blockn = true;
                else
                    blockn = false;
