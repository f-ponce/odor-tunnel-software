...
if ~btw
    color = repmat([1,1,0,0,1;0,0,1,1,1],2,1);
else
    color = [1,0,0,8,1;...
        0,8,1,0,1;...
        1,0,0,8,1;...
...
vis = randperm(length(color(:,1)));
color = color(vis,:);
stm = find(rem(vis,2));
% Begin main script
[stimTimes, stim, duration] = constructStimulus_colorII_l(AlabeL,BlabeL,classical,swappO,stm); % Stimlus
% timecourse
% for experiment
