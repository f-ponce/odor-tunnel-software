function [stimTimes, stim, duration] = constructStimulus_m(A_,B_,swapp,hept)
...
% isi =      [0,45,30,45,45,30,45,45,30,45];
% odorDur = [60,30,30,60,60,60,60,90,90,60];
% isi =      [0,45,30,45];
% odorDur = [60,90,90,60];
...
% isi =      [0,45,30,45,30,45,60,120];
% odorDur = [60,60,60,60,60,60,60,60];
