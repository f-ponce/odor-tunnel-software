function flyTracks = calculateOccupancyStats_mattc_yokedExperiment(flyTracks, refOdor)
...
firstOdorFrame = find(floor(10*flyTracks.relTimes) == (flyTracks.stim{2}(1) + flyTracks.chargeTime),1);
lastOdorFrame = find(ceil(10*flyTracks.relTimes) == (flyTracks.stim{end-2}(1)),1,'last');
