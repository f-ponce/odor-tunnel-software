function varargout = calculateFlyStats_mattc_yokedExperiment(fname, refOdor)
...
% Correct tunnel coordinates post-hoc
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
imshow(flyTracks.bg)
title('Draw a single rectangle encompassing all tunnels. Double-click to continue')
h = imrect;
tunOffset = wait(h);
close(gcf)
flyTracks.tunnels(2,:) = tunOffset(2);
flyTracks.tunnels(4,:) = tunOffset(4);

% Display the new tunnel boundaries
% imshow(flyTracks.bg)
% for i=1:15
%     rectangle('position', flyTracks.tunnels(:,i), 'edgecolor', 'r')
% end
% pause(0.001)
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
flyTracks = calculateChoiceStats_mattc_yokedExperiment(flyTracks, refOdor);
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
flyTracks = calculateOccupancyStats_mattc_yokedExperiment(flyTracks, refOdor);
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
...
MbockPlot2014_mattc_yokedExperiment(flyTracks);
