function flyTracks = flyTracker2014_shortLrn(occtt,iDoD,ttummy)
...
if ttummy
    ...
    [stimTimes, stim, duration] = constructStimulus_shortLrn(AlabeL,BlabeL,iDoD);
    ...
    if stimTimes(ceil(toc))                  % If this is an odor period...
        ...
        if etime(clock, odorTime) >= chargeTime
            ...
            if occtt == true;
                ...
                if bt == 2||bt == 4||bt == 12||bt == 14||bt == 16
                %if bt == 1 
                    blockn = true;
                else
                    blockn = false;
