function [stimTimes, stim, duration] = constructStimulus_jmc(chargeTime)
...
odors = {'Grape' 'Apple'};
conc = [0.1 0.1];                  % proportion saturated vapor
...
fid = fopen('C:\Users\khonegger\Documents\MATLAB\TunnelSoftware\Acquisition\odors_jmc.csv');
