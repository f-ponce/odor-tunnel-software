function [stimTimes, stim, duration] = constructStimulus_color(A_,B_,classical,swapp)
...
isi = [0,15,10,15,10,30,10,15,10,30,10,15,10,30,10,15,10,30,10,15,10,15,10,15,10,30,10,15,10,30,10,15,10,30,10,15,10,30,10,15,10,90];
%odorDur = [180];
%isi = [0];
